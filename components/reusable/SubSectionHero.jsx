export default function SubSectionHero({ header, subheader, illustration, paraClass }) {
  return (
    <div
      ...
      <div className='absolute top-0per left-0per bg-greencss w-50per sm:w-100per md:w-100per h-100per z-0 rounded-right-radius-100px'></div>
      ...
      <div className='relative z-1 col-span-1 flex'>
