export default function SubSectionHero({ header, subheader, illustration, paraClass, isContact = false }) {
  return (
    <div
      className='relative m-auto grid gap-30px sm:gap-0px grid-col-2 sm:grid-col-1 md:grid-col-1 min-h-66vh overflow-hidden'
      style={{ maxWidth: '110rem' }}>
      <div className='absolute top-0per left-0per bg-greencss w-50per h-100per z-neg-1 rounded-right-radius-100px'></div>
