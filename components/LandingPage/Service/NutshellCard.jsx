  ...
  return (
    <>
      {data.sort().map((card, index) => (
        <div
          key={index}
          className={`transition-all transition-duration-500ms p-20px col-1 rounded-10px col-span-1 p-20px sm:mt-25px w-100per border-dark min-h-30rem hover:bg-greencss hover:text-white`}
