...
const Modal = ({ show, onClose, children }) => {
  ...
  const modalContent = show ? (
    <div
      ...
      <div className='absolute z-2 bg-light max-w-50rem w-50rem sm:w-100per max-h-50rem sm:min-h-75vh rounded-10px overflow-scroll overflow-x-hidden min-h-50rem'>
