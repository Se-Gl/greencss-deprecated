        ...
        <div style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">              
            <div style="margin-left: 20px;margin-right: 20px;">
              ...
              <div style="display: flex;justify-content: center;align-items: center;">
                <a href="https://www.greencss.dev" style="text-decoration: none;margin: 8px;color: #101010;">Website</a>
                <a href="https://www.greencss.dev/blog/" style="text-decoration: none;margin: 8px;color: #101010;">Blog</a>
                <a href="https://www.greencss.dev/docs/" style="text-decoration: none;margin: 8px;color: #101010;">Documentation</a>
