      ...
      <div className='grid grid-col-2 gap-30px'>
        <div className='min-w-100per relative col-span-5 sm:col-span-6 md:col-span-6' id='contact-index'>
          <SubSectionHero
            ...
            subheader='Whether it is constructive feedback, negative experiences, gratitude, questions, suggestions, feature requests or simply boredom. omenCSS is open to any kind of feedback and will promptly process your request.'
